...
namespace visualise
{
Scene3D::Scene3D(const models::PlaneWorldModel& world)
...
void Scene3D::update(const cv::Mat& image, const estimators::PoseEstimate& estimate, const Eigen::Matrix3d& K)
{
